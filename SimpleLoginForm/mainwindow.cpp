    ...
    : QMainWindow(parent)
{
    QLabel *lab=new QLabel(this);
        ...
        lab->move(100,50);
        QPixmap pixx("C:/Users/swath/OneDrive/Desktop/user.jpeg");
        lab->setPixmap(pixx.scaled(20,20));

        QLabel *mlabel=new QLabel(this);
        mlabel->move(180,25);
        mlabel->setAlignment(Qt::AlignHCenter);
        QPixmap pix("C:/Users/swath/OneDrive/Desktop/signin.jpeg");
        ...
        labb->move(100,110);
        QPixmap pixxx("C:/Users/swath/OneDrive/Desktop/pwd.jfif");
        ...
        QFont buttons("Times",14,QFont::Bold);
